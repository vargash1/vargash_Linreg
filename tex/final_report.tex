...
% @Last Modified time: 2015-08-04 10:07:44
...
\begin{document}$\\$
	...
	$$\includegraphics[scale=.35]{smoking_sq.png}$$
	...
	$$\includegraphics[scale=.35]{alcohol_sq.png}$$
	...
	$$\includegraphics[scale=.35]{season_sq.png}$$
